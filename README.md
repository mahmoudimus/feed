...
- 🌟 👤 [donvito](https://github.com/donvito) Starred [MiaAI-Lab/Qwen3.8-27B-DFlash2-EXL3-5.0bpw](https://github.com/MiaAI-Lab/Qwen3.8-27B-DFlash2-EXL3-5.0bpw)
...
- 🌟 👤 [fcakyon](https://github.com/fcakyon) Starred [tangsanli5201/DeepPCB](https://github.com/tangsanli5201/DeepPCB)
  > A PCB defect dataset.

### [fengjixuchui](https://github.com/fengjixuchui)
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [fhjowe/YuanGuardHV-SVM-Stealth-Hypervisor](https://github.com/fhjowe/YuanGuardHV-SVM-Stealth-Hypervisor) to [fengjixuchui/YuanGuardHV-SVM-Stealth-Hypervisor](https://github.com/fengjixuchui/YuanGuardHV-SVM-Stealth-Hypervisor)
  > AMD-V SVM/NPT stealth hypervisor (YuanGuardHV)
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [MSNightmare/PrettyPrague](https://github.com/MSNightmare/PrettyPrague) to [fengjixuchui/PrettyPrague](https://github.com/fengjixuchui/PrettyPrague)
  > GenDigital Avast Antivirus ZeroDay Elevation of Privileges Vulnerability

### [frol](https://github.com/frol)
- 🌟 👤 [frol](https://github.com/frol) Starred [joshuaswarren/mlx-omarchy](https://github.com/joshuaswarren/mlx-omarchy)
...
### [jkbrzt](https://github.com/jkbrzt)
- 🌟 👤 [jkbrzt](https://github.com/jkbrzt) Starred [zubair-trabzada/geo-seo-claude](https://github.com/zubair-trabzada/geo-seo-claude)
  > GEO-first SEO skill for Claude Code. Comprehensive AI search optimization for any website — citabili...
...
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [lucid-softworks/auth](https://github.com/lucid-softworks/auth)
  > Native Rust backend for Better Auth clients
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [radixark/miles](https://github.com/radixark/miles)
...
- 🌟 👤 [qiyuangong](https://github.com/qiyuangong) Starred [BenchCAD/BenchCAD-main](https://github.com/BenchCAD/BenchCAD-main)
- 🌟 👤 [qiyuangong](https://github.com/qiyuangong) Starred [davebcn87/pi-autoresearch](https://github.com/davebcn87/pi-autoresearch)
...
- 🌟 👤 [stepancheg](https://github.com/stepancheg) Starred [tweag/rules_s3](https://github.com/tweag/rules_s3)
  > Bazel rules for downloading files from S3 and S3-compatible object storage
...
- 🌟 👤 [zchee](https://github.com/zchee) Starred [JetBrains/skills](https://github.com/JetBrains/skills)
  > Curated agent skills collection verified by JetBrains
- 🌟 👤 [zchee](https://github.com/zchee) Starred [mooncat-greenpy/Ghidra_GolangAnalyzerExtension](https://github.com/mooncat-greenpy/Ghidra_GolangAnalyzerExtension)
  > Analyze Golang with Ghidra
- 🌟 👤 [zchee](https://github.com/zchee) Starred [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills)
