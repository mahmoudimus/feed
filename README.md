...
- 🚀 👤 [BaseMax](https://github.com/BaseMax) Made [BaseMax/persian-diacritics-cleaner](https://github.com/BaseMax/persian-diacritics-cleaner) public
  > A simple Python tool to strip Persian short vowel diacritics (fatha, kasra, damma, shadda, sukun) fr...

### [Bluebugs](https://github.com/Bluebugs)
- 🌟 👤 [Bluebugs](https://github.com/Bluebugs) Starred [ThatDetroitAndy/mutiny](https://github.com/ThatDetroitAndy/mutiny)
  > Mutiny Motors - The open source affordable truck

### [HarukaMa](https://github.com/HarukaMa)
- 🌟 👤 [HarukaMa](https://github.com/HarukaMa) Starred [carbonengine/blue](https://github.com/carbonengine/blue)
  > Blue is the glue between Python and C++. It allows for efficient exposure of C++ classes and functio...
...
- 🍴 👤 [fmeum](https://github.com/fmeum) Forked [google/cpu_features](https://github.com/google/cpu_features) to [fmeum/cpu_features](https://github.com/fmeum/cpu_features)
...
- 🌟 👤 [hsiafan](https://github.com/hsiafan) Starred [yanue/V2rayU](https://github.com/yanue/V2rayU)
  > V2rayU,基于v2ray核心的mac版客户端,用于科学上网,使用swift编写,支持trojan,vmess,shadowsocks,socks5等服务协议,支持订阅, 支持二维码,剪贴板导入,手...
...
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [agno-agi/agent-platform-railway](https://github.com/agno-agi/agent-platform-railway)
  > An agent platform you build, run, evaluate and improve using coding agents.
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [erincatto/box3d](https://github.com/erincatto/box3d)
  > Box3D is a 3D physics engine for games
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [ezyang/ghinbox](https://github.com/ezyang/ghinbox)
  > GitHub simulator
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [meta-pytorch/autoparallel](https://github.com/meta-pytorch/autoparallel)
