...
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [namjaejeon/linux-ntfs](https://github.com/namjaejeon/linux-ntfs) to [fengjixuchui/linux-ntfs](https://github.com/fengjixuchui/linux-ntfs)
  > NTFS(NTFS PLUS) for Linux (Backport for low kernel version support)
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [meowdiocre/meowdiocre](https://github.com/meowdiocre/meowdiocre) to [fengjixuchui/meowdiocre](https://github.com/fengjixuchui/meowdiocre)
  > Windows internals, hypervisors, and reverse engineering.
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [meowdiocre/johnsmithctl](https://github.com/meowdiocre/johnsmithctl) to [fengjixuchui/johnsmithctl](https://github.com/fengjixuchui/johnsmithctl)
  > Windows user-mode control client for the JohnSmith research hypervisor.
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [meowdiocre/vmw](https://github.com/meowdiocre/vmw) to [fengjixuchui/vmw](https://github.com/fengjixuchui/vmw)
  > KVM/Windows research workspace with kernel, QEMU, and firmware patch sets. Tested on AMD hosts.
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [meowdiocre/UpdatedDriverPackScan](https://github.com/meowdiocre/UpdatedDriverPackScan) to [fengjixuchui/UpdatedDriverPackScan](https://github.com/fengjixuchui/UpdatedDriverPackScan)
  > Python scanner for Windows driver PE sections and Authenticode/WHCP signature status.
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [r-c-f/waynergy](https://github.com/r-c-f/waynergy) to [fengjixuchui/waynergy](https://github.com/fengjixuchui/waynergy)
  > A synergy client for Wayland compositors
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [LSPosed/LSPromise](https://github.com/LSPosed/LSPromise) to [fengjixuchui/LSPromise](https://github.com/fengjixuchui/LSPromise)
  > Android complete exploit chain that enables privilege escalation from a local untrusted app to root/...
- 🍴 👤 [fengjixuchui](https://github.com/fengjixuchui) Forked [user-lzy/SnowSword](https://github.com/user-lzy/SnowSword) to [fengjixuchui/SnowSword](https://github.com/fengjixuchui/SnowSword)
...
- 🌟 👤 [h2non](https://github.com/h2non) Starred [pingdotgg/t3code](https://github.com/pingdotgg/t3code)
...
- 🌟 👤 [kovyrin](https://github.com/kovyrin) Starred [px0-ai/px0](https://github.com/px0-ai/px0)
  > px0 is fast, ultra-light, remote-first, read-only IDE designed for instant code navigation and revie...
...
- 🌟 👤 [qiyuangong](https://github.com/qiyuangong) Starred [e2b-dev/runtime](https://github.com/e2b-dev/runtime)
