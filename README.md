...
- 🌟 👤 [Houfeng](https://github.com/Houfeng) Starred [libuv/libuv](https://github.com/libuv/libuv)
  > Cross-platform asynchronous I/O
- 🌟 👤 [Houfeng](https://github.com/Houfeng) Starred [Cubified/tuibox](https://github.com/Cubified/tuibox)
  > A single-header terminal UI (TUI) library, capable of creating mouse-driven, interactive application...
