...
### [frankw2](https://github.com/frankw2)
- 🍴 👤 [frankw2](https://github.com/frankw2) Forked [ArtificialAnalysis/Stirrup](https://github.com/ArtificialAnalysis/Stirrup) to [frankw2/Stirrup](https://github.com/frankw2/Stirrup)
  > The lightweight framework for building agents

### [gamous](https://github.com/gamous)
- 🌟 👤 [gamous](https://github.com/gamous) Starred [DeEpinGh0st/Erebus](https://github.com/DeEpinGh0st/Erebus)
  > CobaltStrike后渗透测试插件
- 🌟 👤 [gamous](https://github.com/gamous) Starred [outflanknl/ntlmrain](https://github.com/outflanknl/ntlmrain)
  > Recover NT hashes from NetNTLMv1 responses using local WebGPU computation and local/remote table loo...
- 🌟 👤 [gamous](https://github.com/gamous) Starred [ja7ad/hydra](https://github.com/ja7ad/hydra)
  > A fast, resilient, multi-source file retriever and download engine
- 🌟 👤 [gamous](https://github.com/gamous) Starred [MSNightmare/ShieldCrash](https://github.com/MSNightmare/ShieldCrash)
  > Windows Defender 0day Vulnerability
- 🌟 👤 [gamous](https://github.com/gamous) Starred [gloxec/CrossC2](https://github.com/gloxec/CrossC2)
...
- 🌟 👤 [jentfoo](https://github.com/jentfoo) Starred [j4m3z0r/bluetti-monitor](https://github.com/j4m3z0r/bluetti-monitor)
  > Bluetti BLE → MQTT bridge for Home Assistant (reverse-engineered; plaintext + encrypted devices, mon...

### [johndpope](https://github.com/johndpope)
- 🌟 👤 [johndpope](https://github.com/johndpope) Starred [korwabs/playwright-trace-mcp](https://github.com/korwabs/playwright-trace-mcp)
...
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [sorkila/lockpaw](https://github.com/sorkila/lockpaw)
  > Cover your Mac screen with a hotkey while AI agents keep running. Dog/cat mascot, native Settings, T...
- 🌟 👤 [nikivdev](https://github.com/nikivdev) Starred [axiosoph/axios](https://github.com/axiosoph/axios)
  > A decentralized system compositor: composition-addressed, verifiable from published source to runnin...
